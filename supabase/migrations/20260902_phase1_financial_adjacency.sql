-- Financial adjunct tables. This migration intentionally follows the canonical
-- wallet migration so all foreign keys resolve on a fresh Supabase deployment.
